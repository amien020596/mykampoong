      ...
      <div className='f' style={{ marginBottom: 50 }}>
        <div className='left'>
          <div>
            ...
            <Title level={2} style={{ fontWeight: 500, marginTop: 30 }}>{item.name}</Title>
            <div style={{ marginBottom: 42 }}>
              <Tag type='experience'>Experience</Tag>
              <Text style={{ margin: '0 10px 0 5px' }}>·</Text>
              <StarFilled style={{ color: 'var(--orange500)' }} />
              &nbsp;
              <Text>{Number(item.rating_review).toFixed(1)} ({item.count_review})</Text>
              <Text style={{ margin: '0 10px 0 5px' }}>·</Text>
            ...
            <div className='f f-btw' style={{ marginTop: 30 }}>
              ...
              <div>
                <Avatar size={58}>{parseName(item.tourist_actors.owner_name)}</Avatar>
              </div>
            </div>
            <div className='separator' />
            <Location />
